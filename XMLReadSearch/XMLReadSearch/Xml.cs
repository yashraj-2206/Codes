    ...
    public class Xml
    {
        ...
        public Dictionary<string, string> IsValidXML(string xmlPath)
        {
            try
            {
                ...
                string xsdPath = @"C:\Users\yashr\OneDrive\Desktop\XMLReadSearch\XMLReadSearch\Resources\XMLValidatingSchema.xsd";
                ...
                {
                    /*string srno = node.Attributes["SrNo"].InnerText;
                    string ip = node.SelectSingleNode("Address").InnerText;
                    if (srList.Contains(srno))
                    {
                    ...
                    srList.Add(node.Attributes["SrNo"].InnerText);
                    ipList.Add(node.SelectSingleNode("Address").InnerText);*/
        ...
        {
            Console.WriteLine("NOt implementedddd");
            throw new NotImplementedException();
        }

        public void ValidationCallback(ValidationEventArgs e)
        {
